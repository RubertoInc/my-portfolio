...
export function SiteFooter() {
  return (
    <footer className="relative z-10 border-t border-white/10 bg-black/35 px-6 py-5 text-[11px] text-neutral-300/80 backdrop-blur-sm md:px-10 md:text-xs md:uppercase md:tracking-[0.28em]">
