...
export const narrativeProjects: NarrativeProject[] = [
  {
    ...
    crew: [
      ...
      "Original Score — AKILA",
      "Production Designer — Vashti Anne",
      "Director of Photography — Jacob Lea",
      "1st AC — Sarah Sun",
      "Gaffer — Marco Ciardullo",
      "Light Board Operator — Evan Jones",
      "Location Sound Mixer / Boom-Op — Nicolas Field",
      "Editor / Graphics — Damen R. Brar",
      "Colourist — Andrew Lea",
      "Sound Designer / Re-recording Mixer — Alexandra Huynh Do",
      "Vocals / Lyrics — Joelle Rose Peresin",
      "Bass / Guitar — Kaashff Earle",
      "Saxophone — Ridgeclub",
      "Featuring \"LUCKY\" by — AKILA and The Wonder Machine",
    ],
  },
];
